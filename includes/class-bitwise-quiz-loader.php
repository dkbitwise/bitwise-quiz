...
class Bitwise_Quiz_Loader {
	...
	public function add_shortcode( $hook, $component, $callback, $priority = 10, $accepted_args = 1 ) {
		$this->shortocdes = $this->add( $this->shortocdes, $hook, $component, $callback, $priority, $accepted_args );
	}
	...
	/**
	 * Register the actions, filter and actions with WordPress.
	 *
	 * @since    1.0.0
	 */
	public function run() {
		...
		foreach ( $this->shortocdes as $hook ) {
